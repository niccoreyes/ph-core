...
* Examples for this Extension: [Bundle/transaction-example](Bundle-transaction-example.md), [Philippine General Hospital](Location-location-single-example.md), [Department of Health - Sattelite Office](Organization-organization-single-example.md), [Patient/example-patient](Patient-example-patient.md)... Show 2 more, [Patient/patient-single-example](Patient-patient-single-example.md) and [RelatedPerson/relatedperson-single-example](RelatedPerson-relatedperson-single-example.md)
