...
```json
{
  ...
  "address" : [{
    "extension" : [{
      "url" : "https://fhir.doh.gov.ph/ph-core/StructureDefinition/barangay",
      "valueCoding" : {
    ...
    {
      "url" : "https://fhir.doh.gov.ph/ph-core/StructureDefinition/city-municipality",
      "valueCoding" : {
        "system" : "https://psa.gov.ph/classification/psgc",
        "code" : "1380600000",
    ...
    {
      "url" : "https://fhir.doh.gov.ph/ph-core/StructureDefinition/region",
      "valueCoding" : {
        "system" : "https://psa.gov.ph/classification/psgc",
        "code" : "1300000000",
