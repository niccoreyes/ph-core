...
* Examples for this Extension: [Philippine General Hospital](Location-location-single-example.md), [Department of Health - Sattelite Office](Organization-organization-single-example.md) and [RelatedPerson/relatedperson-single-example](RelatedPerson-relatedperson-single-example.md)
