...
**Server Capability:** Supports FHIR R4, all CRUD operations, transaction Bundles (see the [PH Core CapabilityStatement](CapabilityStatement-ExamplePHCoreCapabilityStatement.html) for full conformance requirements)
...
This shows what the server supports (which resources, operations, etc.). Compare the server response against the [PH Core CapabilityStatement](CapabilityStatement-ExamplePHCoreCapabilityStatement.html) to verify conformance.
