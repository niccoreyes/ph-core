...
* Examples for this Profile: [Philippine General Hospital](Organization-organization-pgh-example.md) and [Department of Health - Sattelite Office](Organization-organization-single-example.md)
