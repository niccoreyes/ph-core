...
* Examples for this Profile: [Patient/example-patient](Patient-example-patient.md), [Patient/patient-acs-example](Patient-patient-acs-example.md) and [Patient/patient-single-example](Patient-patient-single-example.md)
