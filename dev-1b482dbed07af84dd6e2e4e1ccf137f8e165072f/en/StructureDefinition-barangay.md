...
* Examples for this Extension: [Bundle/bundle-acs-case-example](Bundle-bundle-acs-case-example.md), [Bundle/transaction-example](Bundle-transaction-example.md), [Philippine General Hospital](Organization-organization-pgh-example.md), [Department of Health - Sattelite Office](Organization-organization-single-example.md)... Show 5 more, [Patient/example-patient](Patient-example-patient.md), [Patient/patient-single-example](Patient-patient-single-example.md), [Practitioner/practitioner-ed-example](Practitioner-practitioner-ed-example.md), [Practitioner/practitioner-single-example](Practitioner-practitioner-single-example.md) and [RelatedPerson/relatedperson-single-example](RelatedPerson-relatedperson-single-example.md)
