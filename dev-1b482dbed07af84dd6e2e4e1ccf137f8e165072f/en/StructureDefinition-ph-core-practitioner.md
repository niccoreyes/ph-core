...
* Examples for this Profile: [Practitioner/example-practitioner](Practitioner-example-practitioner.md), [Practitioner/practitioner-ed-example](Practitioner-practitioner-ed-example.md) and [Practitioner/practitioner-single-example](Practitioner-practitioner-single-example.md)
